...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_voucher'])) {
    ...
    if ($edit_id > 0) {
        ...
        $stmt->bind_param("ssisidssi", $type, $payment_method, $bank_id, $party_id, $amount, $date, $desc, $edit_id);
    } else {
        ...
        $stmt->bind_param("issisids", $dept_id, $type, $payment_method, $bank_id, $party_id, $amount, $date, $desc);
    }
